...
@Service
class DoctorServiceImpl(@Autowired val doctorRepository: DoctorRepository, @Autowired val hospitalDetailsRepository: HospitalDetailsRepository, private val droolsClient: DroolsClient) : BasicCrud<String, Doctor> {
